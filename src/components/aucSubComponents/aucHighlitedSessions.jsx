...
import { FaBook, FaGraduationCap, FaChartLine, FaTheaterMasks, FaNewspaper, FaUsers } from "react-icons/fa";
  ...
  const sessions = [
    {
      ...
      isHighlighted: false,
      icon: <FaBook className="w-16 h-16 sm:w-20 sm:h-20 text-red-800" />,
    },
    {
      title: "Future of Education",
      venue: "IBA Sukkur University",
      icon: <FaGraduationCap className="w-16 h-16 sm:w-20 sm:h-20 text-red-800" />,
      isHighlighted: false,
    },
    {
      title: "Global Economics",
      venue: "IBA Sukkur University",
      icon: <FaChartLine className="w-16 h-16 sm:w-20 sm:h-20 text-red-800" />,
      isHighlighted: false,
    },
    {
      title: "Cultural Performances",
      venue: "IBA Sukkur University",
      icon: <FaTheaterMasks className="w-16 h-16 sm:w-20 sm:h-20 text-red-800" />,
      isHighlighted: false,
    },
    {
      title: "Media & Journalism",
      venue: "IBA Sukkur University",
      icon: <FaNewspaper className="w-16 h-16 sm:w-20 sm:h-20 text-red-800" />,
      isHighlighted: false,
    },
    {
      ...
      venue: "IBA Sukkur University",
      isHighlighted: false,
      icon: <FaUsers className="w-16 h-16 sm:w-20 sm:h-20 text-red-800" />,
    },
  ];
    ...
    <section className="py-12 px-6 sm:px-6 md:px-8 bg-white text-black relative overflow-hidden" id="aucHighlightedSessions">
      <div className="mx-auto max-w-7xl relative z-10">
        <motion.h2
          ...
          className="text-2xl sm:text-4xl md:text-4xl font-bold text-center mb-12 text-red-900 tracking-tight"
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {sessions.map((session, index) => (
            <motion.div
              ...
              className="relative bg-red-900 rounded-xl overflow-hidden shadow-lg flex flex-col"
            ...
            >
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                ...
                <motion.div
                  className="mt-4 w-12 h-1 bg-red-300 rounded-full"
