...
import { FaTheaterMasks, FaImage, FaMusic, FaChalkboardTeacher, FaUsers } from 'react-icons/fa';
...
const ShowcaseSection = () => {
  const showcases = [
    ...
    { id: 4, title: 'Exhibition', desc: 'Explore stunning art and cultural displays.', icon: FaImage, size: 'medium' },
    { id: 5, title: 'Workshop', desc: 'Participate in interactive skill-building sessions.', icon: FaChalkboardTeacher, size: 'medium' },
    { id: 6, title: 'Community Building', desc: 'Join events fostering community and collaboration.', icon: FaUsers, size: 'small' },
  ];

  return (
    <section className="py-12 bg-white text-center">
      <h2 className="text-2xl md:text-4xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-700">Showcase</h2>
        ...
        {showcases.map((showcase, index) => (
          <div
            ...
            className={`p-6 rounded-lg shadow-md ${showcase.size === 'large' ? 'col-span-1' : showcase.size === 'medium' ? 'col-span-1 md:col-span-1' : 'col-span-1 md:col-span-1'
              } ${showcase.size === 'large' ? 'h-64' : showcase.size === 'medium' ? 'h-48' : 'h-48'}`}
          >
